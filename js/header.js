...
function headerchange(check)
{
	if(check==1)
	{
		...
		var img=document.getElementById('homaj-home').src="home-hover.png";
	}
	else if(check==2)
	{
		var text=document.getElementById('p2').style.color="white";
		var img=document.getElementById('homaj-profile').src="profile-hover.png";
	}
	else if(check==3)
	{
		var text=document.getElementById('p3').style.color="white";
		var img=document.getElementById('homaj-society').src="society-hover.png";
	}
	else if(check==4)
	{
		var text=document.getElementById('p4').style.color="white";
		var img=document.getElementById('homaj-message').src="message-hover.png";
	}
	else if(check==5)
	{
		var text=document.getElementById('p5').style.color="white";
		var img=document.getElementById('homaj-notification').src="notification-hover.png";
	}
}
...
function headerorigin(check)
{
	...
	{
		var text=document.getElementById('p1').style.color="white";
		var img=document.getElementById('homaj-home').src="home.png";
	}
	else if(check==2)
	{
		var text=document.getElementById('p2').style.color="white";
		var img=document.getElementById('homaj-profile').src="profile.png";
	}
	else if(check==3)
	{
		var text=document.getElementById('p3').style.color="white";
		var img=document.getElementById('homaj-society').src="society.png";
	}
	else if(check==4)
	{
		var text=document.getElementById('p4').style.color="white";
		var img=document.getElementById('homaj-message').src="message.png";
	}
	else if(check==5)
	{
		var text=document.getElementById('p5').style.color="white";
		var img=document.getElementById('homaj-notification').src="notification.png";
	}
}
